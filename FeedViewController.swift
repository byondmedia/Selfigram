...
//  Selfigram
//
//  Created by Alejandra Anderson on 2016-11-15.
...
//    }
    ...
    var posts = [Post]()
    var words = ["Hello", "my", "name", "is", "Alejandra"]
    
    override func viewDidLoad() {
       
        
        let url = URL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.search&format=json&nojsoncallback=1&api_key=cb62d50b08e8d3235a982091837e8b9d&tags=cat")!
                    ...
                    for photo in photosArray {
                        ...
                        if let farmID = photo["farm"] as? Int,
                            ...
                            if let photoURL = URL(string: photoURLString) {
                                ...
                                let me = User(aUsername: "Alejandra", aProfileImage: UIImage(named: "Grumpy-Cat")!)
        ...
        //let me = User(username: "Alejandra", profileImage: UIImage(named: "Grumpy-Cat")!)
        
        
        
//        let post0 = Post(image: UIImage(named: "Grumpy-Cat")!, user: me, comment: "Lovely Cat 0")
//        let post1 = Post(image: UIImage(named: "Grumpy-Cat")!, user: me, comment: "Sad Cat 1")
//        let post2 = Post(image: UIImage(named: "Grumpy-Cat")!, user: me, comment: "Lovely Cat 2")
//        let post3 = Post(image: UIImage(named: "Grumpy-Cat")!, user: me, comment: "Sad Cat 3")
//        let post4 = Post(image: UIImage(named: "Grumpy-Cat")!, user: me, comment: "Lovely Cat 4")
